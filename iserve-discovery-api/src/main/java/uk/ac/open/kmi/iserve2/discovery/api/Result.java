 ...
 */
package uk.ac.open.kmi.iserve2.discovery.api;

import java.io.Serializable;

public class Result implements Serializable {

	private static final long serialVersionUID = 3812920495225716854L;
	...
	public Result(String uri, String matchingDegree) {
		setUri(uri);
		setDegreeName(null);
		setMatchingDegree(matchingDegree);
	}
