 ...
 */
public class ReverseRanker implements Ranker {
    @Override
    public SortedMap<URI, Double> rank(Map<URI, Double> map) {

        Ordering<URI> byScoreOrdering = Ordering.natural().onResultOf(Functions.forMap(map)).compound(Ordering.usingToString());
