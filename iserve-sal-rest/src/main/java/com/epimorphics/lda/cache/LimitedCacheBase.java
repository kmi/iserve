...
//    	}
    ...
    @Override
    public synchronized APIResultSet getCachedResultSet(List<Resource> results, String view) {
    ...
    @Override
    public synchronized void cacheDescription(List<Resource> results, String view, APIResultSet rs) {
    ...
    @Override
    public synchronized void cacheSelection(String select, List<Resource> results) {
