...
public class PermaCache extends LimitedCacheBase implements Cache {
    ...
    @Override
    protected synchronized boolean exceedsSelectLimit(Cachelet<String, List<Resource>> m) {
        return false;
    }

    @Override
    protected synchronized boolean exceedsResultSetLimit(Cachelet<String, APIResultSet> m) {
        return false;
    }
}