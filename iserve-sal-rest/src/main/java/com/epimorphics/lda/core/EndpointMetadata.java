...
public class EndpointMetadata {
    ...
    (boolean isListEndpoint
        ...
        //
        if (wantsMeta.wantsMetadata("versions")) metaModel.add(versionsModel);
        else setsMeta.setMetadata("versions", versionsModel);
        if (wantsMeta.wantsMetadata("formats")) metaModel.add(formatsModel);
        else setsMeta.setMetadata("formats", formatsModel);
        if (wantsMeta.wantsMetadata("bindings")) metaModel.add(bindingsModel);
        else setsMeta.setMetadata("bindings", bindingsModel);
        if (wantsMeta.wantsMetadata("execution")) metaModel.add(execution);
        else setsMeta.setMetadata("execution", execution);
    }
