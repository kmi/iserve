...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="result" mode="script">
        ...
        <script type="text/javascript">
            ...
            <xsl:if test="$showMap = 'true'">
                ...
                '';
                window.location = '<xsl:value-of select="concat($uri, $sep, $properties)"/>min-<xsl:value-of
    ...
    <xsl:template match="*" mode="filter">
        ...
        <xsl:choose>
            ...
            <xsl:when
                    test="$datatype = 'integer' or $datatype = 'decimal' or $datatype = 'float' or $datatype = 'int' or $datatype = 'date' or $datatype = 'dateTime' or $datatype = 'time'">
