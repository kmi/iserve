<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="orgLinks">
            ...
            <xsl:when test="starts-with($base, '/doc/department/')">
                ...
                <ul>
                    ...
                    <xsl:call-template name="moreinfoLink">
                        ...
                        <xsl:with-param name="current" select="$base"/>
                        <xsl:with-param name="label">Department
                            <abbr title="Senior Civil Service">SCS</abbr>
                            posts
                        </xsl:with-param>
                    </xsl:call-template>
                    <xsl:call-template name="moreinfoLink">
            ...
            <xsl:when test="starts-with($base, '/doc/public-body/')">
                ...
                <ul>
                    <xsl:call-template name="moreinfoLink">
                        ...
                        <xsl:with-param name="current" select="$base"/>
                        <xsl:with-param name="label">Public body
                            <abbr title="Senior Civil Service">SCS</abbr>
                            posts
                        </xsl:with-param>
                    </xsl:call-template>
        ...
        <xsl:choose>
            ...
            <xsl:when
                    test="starts-with($base, '/def/') and (type/item/@href = 'http://www.w3.org/2000/01/rdf-schema#Class' or type/item/@href = 'http://www.w3.org/2002/07/owl#Class')">
                <ul>
                    <li>
                        <a href="{$base}/property">Properties</a>
                    </li>
                    <li>
                        <a href="{$base}/instance">Instances</a>
                    </li>
                    <li>
                        <a href="{$base}/subclass">Subclasses</a>
                    </li>
                </ul>
            </xsl:when>
        </xsl:choose>
