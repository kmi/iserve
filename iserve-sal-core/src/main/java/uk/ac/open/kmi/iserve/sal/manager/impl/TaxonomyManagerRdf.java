...
//
//	/* (non-Javadoc)
//	 * @see uk.ac.open.kmi.iserve.sal.manager.TaxonomyManager#addTaxonomy(java.net.URI)
//	 */
//	@Override
//	public boolean addTaxonomy(URI taxonomyUri) throws TaxonomyException {
//		if ( taxonomyUri == null || !taxonomyUri.isAbsolute()) {
//			throw new TaxonomyException("Taxonomy URI is null");
//		}
//		try {
//			InputStream is = taxonomyUri.toURL().openStream();
//			RepositoryModel model = repoConnector.openRepositoryModel();
