...
public class ModelReferenceImpl extends EntityImpl implements ModelReference {

	/**
	 * serial version UID
	 */
	private static final long serialVersionUID = 990746254865081641L;

	public ModelReferenceImpl() {
		super();
	}

	public ModelReferenceImpl(URI uri) {
		super(uri);
	}
