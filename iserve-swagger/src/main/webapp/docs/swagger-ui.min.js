...
(function () {
    ...
    a.param = b(function (f, q, o, j, t) {
        ...
        function k(y, x) {
            var v = "", w;
            v += "\n			";
            w = o["if"].call(y, y.defaultValue, {hash: {}, inverse: n.program(7, h, x), fn: n.program(5, i, x), data: x});
            if (w || w === 0) {
                v += w
            }
            v += "\n		";
        ...
        function u(y, x) {
            var v = "", w;
            v += "\n			";
            w = o["if"].call(y, y.defaultValue, {hash: {}, inverse: n.program(13, r, x), fn: n.program(11, s, x), data: x});
            if (w || w === 0) {
                v += w
            }
            v += "\n		";
...
(function () {
    ...
    u = (function (y) {
        ...
        A.prototype.addResource = function (C) {
            var B;
            B = new n({model: C, tagName: "li", id: "resource_" + C.id, className: "resource", swaggerOptions: this.options.swaggerOptions});
    ...
    o = (function (z) {
        ...
        y.prototype.events = {"submit .sandbox": "submitOperation", "click .submit": "submitOperation", "click .response_hider": "hideResponse", "click .toggleOperation": "toggleOperationContent", "mouseenter .api-ic": "mouseEnter", "mouseout .api-ic": "mouseExit"};
        y.prototype.initialize = function () {
        };
        ...
        y.prototype.render = function () {
            ...
            if (this.model.responseClassSignature && this.model.responseClassSignature !== "string") {
                M = {sampleJSON: this.model.responseSampleJSON, isParam: false, signature: this.model.responseClassSignature};
        ...
        y.prototype.handleFileUpload = function (R, I) {
            ...
            L = {type: this.model.method, url: this.invocationUrl, headers: C, data: M, dataType: "json", contentType: false, processData: false, error: function (X, Y, W) {
    ...
    p = (function (z) {
        ...
        y.prototype.render = function () {
            ...
            if (swaggerUi.api.models.hasOwnProperty(this.model.responseModel)) {
                B = {sampleJSON: JSON.stringify(swaggerUi.api.models[this.model.responseModel].createJSONSample(), null, 2), isParam: false, signature: swaggerUi.api.models[this.model.responseModel].getMockSignature()};
